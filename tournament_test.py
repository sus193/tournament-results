...
def testPairings():
    ...
    # registerPlayer("Applejack")
    # registerPlayer("Pinkie Pie")
    # registerPlayer("Leslie Lava")   
    # registerPlayer("YoYo Mama")
    # registerPlayer("Momo Na")
    # registerPlayer("Lobo Lolo")
    # standings = playerStandings()
    ...
    # correct_pairs = set([frozenset([id1, id3]), frozenset([id5, id7]), frozenset([id8, id2]), frozenset([id6, id4])])
